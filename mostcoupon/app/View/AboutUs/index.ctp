...
<div class="team-slider">
    <div class="container">
        <div class="slider flexslider" data-flexslider-animation="slide" data-flexslider-animation-speed="2000" data-flexslider-control-nav="false" data-flexslider-direction-nav="true" data-flexslider-selector=".slides .slide" data-flexslider-item-width="400" data-flexslider-item-margin="0">
            <div class="slides">
                ...
                <div class="skill-set">
                    <div class="skill">
                        ...
                        <div class="skill-level progress">
                            <div class="progress-bar" ng-style="{'width' : sk1Value + '%'}"> 
                                <span>{{sk1Value}}%</span> 
                            </div>
                        </div>
                    </div>
                    <div class="skill">
                        ...
                        <div class="skill-level progress">
                            <div class="progress-bar" ng-style="{'width' : sk2Value + '%'}"> 
                                <span>{{sk2Value}}%</span> 
                            </div>
                        </div>
                    </div>
                    <div class="skill">
                        ...
                        <div class="skill-level progress">
                            <div class="progress-bar" ng-style="{'width' : sk3Value + '%'}"> 
                                <span>{{sk3Value}}%</span> 
                            </div>
                        </div>
                    </div>
                    <div class="skill">
                        ...
                        <div class="skill-level progress">
                            <div class="progress-bar" ng-style="{'width' : sk4Value + '%'}"> 
                                <span>{{sk4Value}}%</span> 
                            </div>
                        </div>
                    </div>
