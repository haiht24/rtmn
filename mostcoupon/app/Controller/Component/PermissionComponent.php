...
class PermissionComponent extends Component {
    ...
    public $components = array('Session', 'mCusApi');
    ...
    private function _refresh() {
        if($this->Session->check('Auth')) {
            ...
            if(!$timestamp || !CakeTime::isToday($timestamp, 'America/New_York')) {
                $user = $this->mCusApi->resource('User')->get($this->Session->read('Auth.User.Id'));
