...
class Resource {
    ...
    public function request($uri, $options = array()) {
        ...
        return mCusApiComponent::decodeResponse($this->_controller, $response->body);
    }
...
class mCusApiComponent extends Component {         
    ...
    public static function decodeResponse($controller, $response) {
        ...
        if(isset($result['error'])) {
            if ($result['error'] === "IncorrectCredentialsException") {
                ...
                $controller->Session->setFlash('Your session has ended. Please log in again.', 'default', array(), 'error');                                
