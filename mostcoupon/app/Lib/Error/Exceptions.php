 ...
 */
class mCusFrontendException extends CakeException {
...
class ApiServerException extends mCusFrontendException {
...
class ExampleException extends mCusFrontendException {

    public function __construct($args = '') {
        parent::__construct($args, 404);
    }
}
