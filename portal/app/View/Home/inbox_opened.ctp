...
<div class="inbox-info-bar">
    <div class="row">
        <div class="col-sm-9">
            <img src="<?= $this->Html->webroot('/', true)?>img/avatars/5.png" alt="me" class="away">
...
<div class="inbox-message">
    ...
    <br>
    <img src="<?= $this->Html->webroot('/', true)?>img/logo-blacknwhite.png" height="20" width="auto" style="margin-top:7px; padding-right:9px; border-right:1px dotted #9B9B9B;" />
</div>
    ...
    <ul class="inbox-download-list">
        <li>
            <div class="well well-sm">
				<span>
					<img src="<?= $this->Html->webroot('/', true)?>img/demo/sample.jpg">
				</span>
                <br>
...
<div class="email-infobox">
    ...
    <ul class="list-inline">
        <li><img src="<?= $this->Html->webroot('/', true)?>img/avatars/5.png" alt="me" width="30px"></li>
        <li><img src="<?= $this->Html->webroot('/', true)?>img/avatars/3.png" alt="me" width="30px"></li>
        <li><img src="<?= $this->Html->webroot('/', true)?>img/avatars/sunny.png" alt="me" width="30px"></li>
...
<script type="text/javascript">
    ...
    $(".replythis").click(function(){
        loadURL("inbox_reply", $('#inbox-content > .table-wrap'));
    })
