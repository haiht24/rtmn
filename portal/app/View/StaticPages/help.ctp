<?php $this->Ng->ngController('HelpCtrl') ?>
<?php
    $this->Ng->ngInit(
        [
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
    	<h1 class="page-title txt-color-blueDark">
            <i class="fa fa-edit fa-fw "></i>Documents Config <span><a target="_blank" href="<?php echo str_replace('portal', 'frontend', $this->Html->url('/HelpPage/index', true));?>">&gt; Page {{pageName}}</a></span>
    	</h1>
    </div>
</div>
...
<div data-widget-sortable="false" data-widget-fullscreenbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false" id="wid-id-0" class="jarviswidget jarviswidget-color-darken">
    ...
    <div>
        ...
        <div class="widget-body no-padding">
            <textarea ng-model = "help" name="ckeditor" style="visibility: hidden; display: none;"></textarea>
        </div>
        <!-- end widget content -->
    </div>
    <!-- end widget div -->
