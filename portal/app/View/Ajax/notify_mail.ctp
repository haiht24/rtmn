<ul class="notification-body">
    <li>
        <span class="unread">
            <a href="javascript:void(0);" class="msg">
                <img src="<?= $this->Html->webroot('/', true) ?>img/avatars/4.png" alt=""
                     class="air air-top-left margin-top-5" width="40" height="40"/>
    ...
    <li>
        <span>
            <a href="javascript:void(0);" class="msg">
                <img src="<?= $this->Html->webroot('/', true) ?>img/avatars/female.png" alt=""
                     class="air air-top-left margin-top-5" width="40" height="40"/>
    ...
    <li>
        <span>
            <a href="javascript:void(0);" class="msg">
                <img src="<?= $this->Html->webroot('/', true) ?>img/avatars/1.png" alt=""
                     class="air air-top-left margin-top-5" width="40" height="40"/>
                <span class="from">Cristina Algera</span>
                <time>Sunday, September 15th</time>
                <span class="subject">Best-Selling Teethers</span>
                <span
                    class="msg-body"> ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur?</span>
            </a>
        </span>
    </li>
    <li>
        <span>
            <a href="javascript:void(0);" class="msg">
                <img src="<?= $this->Html->webroot('/', true) ?>img/avatars/male.png" alt=""
                     class="air air-top-left margin-top-5" width="40" height="40"/>
    ...
    <li>
        <span class="unread">
            <a href="javascript:void(0);" class="msg">
                <img src="<?php echo $this->Html->url('/img/avatars/sunny.png') ?>" alt=""
                     class="air air-top-left margin-top-5" width="40" height="40"/>
