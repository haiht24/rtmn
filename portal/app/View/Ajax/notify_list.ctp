<ul class="notification-body">
    <li>
        <span class="padding-10 unread">
            ...
            <span>
                 2 new users just signed up! <span class="text-primary">martin.luther</span> and <span
                    class="text-primary">kevin.reliey</span>
                 <br>
    ...
    <li>
        <span class="padding-10">
            ...
            <span>
                 2 projects were completed on time! Submitted for your approval - <a href="javascript:void(0);"
                                                                                     class="display-normal">Click
                    here</a>
                 <br>
