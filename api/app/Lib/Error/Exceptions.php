...
class DuplicateEmailException extends mCusException {
    
    public function __construct() {
        parent::__construct('Email duplicate');
    }
}
class DuplicateUsernameException extends mCusException {
    
    public function __construct() {
        parent::__construct('Username duplicate');
    }
}
